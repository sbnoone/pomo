...
export const Chip: FC<{
	...
	return (
		<div className='flex items-center gap-x-[9px] border-2 border-solid border-blue-900 dark:border-blue-50 bg-blue-100 text-blue-900 dark:text-green-50 rounded-[999px] px-4 py-2 font-medium'>
			{config[variant].icon}
			{config[variant].text}
		</div>
	)
